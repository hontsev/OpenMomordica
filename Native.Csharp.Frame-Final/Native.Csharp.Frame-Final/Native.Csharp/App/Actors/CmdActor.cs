    ...
    public class Configs
    {
        ...
        public void init(string filePath)
        {
            ...
            try
            {
                ...
                if (configs.ContainsKey("starttime")) startTime = DateTime.ParseExact(configs["starttime"], "yyyy-MM-dd hh:mm:ss", System.Globalization.CultureInfo.CurrentCulture);
                if (configs.ContainsKey("startnum")) beginTimes = long.Parse(configs["startnum"]);
